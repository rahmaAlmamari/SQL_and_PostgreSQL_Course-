...
**~~NOTE:~~** this section based on this DB and data:
...
## 1. Queries with Joins and Aggregations

![join and agriegation](./images/join_ag.png)

## 2. Joining Data from Different Tables

**Example One:**

![join example one](./images/join_example_one.png)
...
![join example one](./images/join_example_one2.png)

![join example one](./images/join_example_one3.png)

**Example Two:**

![join example two](./images/join_example_two.png)
...
![join example two](./images/join_example_two2.png)

![join example two](./images/join_example_two3.png)

~~NOTE:~~ 

![join NOTE](./images/join_note.png)


## 3. Four Kinds of Joins

[PDF Link](./pdf/join_type_pdf.pdf)

**Join type example:**

~~NOTE:~~ this example need to more data 

```sql

INSERT INTO photos (url, user_id)
VALUES ('http://hdsk.om', NULL);
...
-- this user do not have a photo 

```

**1. Inner Join**

Q: lest all photos url with user name?
...
Q: lest all url and username even if photo do not belong to user (user_id = null)
...
Q: lest all username with url even if user do not have a photo
...
Q: lest all url and username even if photo do not belong to user or user do not have photo
...
**Three Way Join** is when we join three tables together. 
